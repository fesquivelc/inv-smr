...
public class MantenimientoPeriodo extends javax.swing.JInternalFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(idField, javax.swing.GroupLayout.DEFAULT_SIZE, 310, Short.MAX_VALUE)
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (tblperiodo.getSelectedRow() != -1) {
            Integer codigo = (Integer) tblperiodo.getModel().getValueAt(tblperiodo.getSelectedRow(), 0);

            Periodo periodo = periodoControlador.buscarPorId(codigo);
            ...
            if (periodo != null) {
                if (JOptionPane.showConfirmDialog(null, "¿Desea Eliminar el Periodo?", "Mensaje del Sistema", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                    ...
                    if (periodoControlador.accion(accion) == 3) {
                        ...
                        JOptionPane.showMessageDialog(null, "Periodo no eliminado", "Mensaje del Sistema", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Periodo no eliminado", "Mensaje del Sistema", JOptionPane.ERROR_MESSAGE);
                }
