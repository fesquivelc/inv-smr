 ...
 * @author juvitec
 */
public class MantenimientoTipoUsuario extends javax.swing.JInternalFrame {

    /**
     * Creates new form MantenimientoTipoUsuario
     */
    
    private static MantenimientoTipoUsuario instancia;
    ...
    public static MantenimientoTipoUsuario getInstancia() {
        if (instancia == null) {
            instancia = new MantenimientoTipoUsuario();
        }
        return instancia;
    }
    ...
    private final TipoUsuarioControlador tipoUsuarioControlador = new TipoUsuarioControlador();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Lista de tipos de usuario:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(77, 77, 77)
                .addComponent(usuarioField, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        lista.clear();
        lista.addAll(this.tipoUsuarioControlador.buscarXNombre(txtbuscar.getText().toUpperCase()));
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (accion == 1) {
            ...
            if (JOptionPane.showConfirmDialog(null, "¿Desea " + palabra + " el Usuario?", "Mensaje del Sistema", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                tipoUsuarioControlador.getSeleccionado().setNombre(usuarioField.getText());
                
                lista.add(tipoUsuarioControlador.getSeleccionado());
                tipoUsuarioControlador.accion(accion);
                if (accion == 1) {
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (tbltipousuario.getSelectedRow() != -1) {
            ...
            TipoUsuario tipoUsuario = tipoUsuarioControlador.buscarPorId(codigo);
            ...
            if (tipoUsuario != null) {
                if (JOptionPane.showConfirmDialog(null, "¿Desea Eliminar el Usuario?", "Mensaje del Sistema", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                    ...
                    int[] filas = tbltipousuario.getSelectedRows();
                    for (int i = 0; i < filas.length; i++) {
                        TipoUsuario tipoUsuario2 = lista.get(filas[0]);
                        lista.remove(tipoUsuario2);
                        tipoUsuarioControlador.setSeleccionado(tipoUsuario2);
                        tipoUsuarioControlador.accion(accion);
                    }
                    if (tipoUsuarioControlador.accion(accion) == 3) {
    ...
    private void listar() {
        lista = tipoUsuarioControlador.buscarTodos();
        lista = ObservableCollections.observableList(lista);
        JTableBinding binding = SwingBindings.createJTableBinding(AutoBinding.UpdateStrategy.READ, lista, tbltipousuario);
