 ...
 * @author fesquivelc
 */
public class DlgAmbiente extends javax.swing.JDialog {

    /**
     * Creates new form dlgAmbiente
     */
    AmbienteControlador ambienteControlador =  new AmbienteControlador();
    List<Ambiente> lista;
    Ambiente seleccionado;
    
    
    public DlgAmbiente(JInternalFrame parent, boolean modal) {
    ...
    public Ambiente getSeleccionado() {
    ...
    private void buscar() {
        lista.clear();
        lista.addAll(ambienteControlador.buscarXNombre(txtAmbiente.getText()));
    }
}
